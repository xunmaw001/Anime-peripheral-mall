  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">动漫周边商城注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dianpubianhao" class="input" type="text" placeholder="店铺编号">
			   </div>
			 </div> -->
			<el-form-item label="店铺编号" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.dianpubianhao" autocomplete="off" placeholder="店铺编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="店铺名称" class="input" v-if="tableName=='maijia'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='maijia'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
												...
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">店铺邮箱</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianpuyouxiang" class="input" type="text" placeholder="店铺邮箱">
			   </div>
			 </div> -->
			<el-form-item label="店铺邮箱" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.dianpuyouxiang" autocomplete="off" placeholder="店铺邮箱" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='maijia'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                        ...
                                                                        if(`maijia` == this.tableName && this.ruleForm.dianpuyouxiang&&(!this.$validate.isEmail(this.ruleForm.dianpuyouxiang))){
        this.$message.error(`店铺邮箱应输入邮件格式`);
        return
      }
                                                                                                                                                      if(`maijia` == this.tableName && this.ruleForm.jifen&&(!this.$validate.isIntNumer(this.ruleForm.jifen))){
        this.$message.error(`积分应输入整数`);
        return
      }
