          ...
          <el-form-item class="input" label="店铺名称" prop="dianpumingcheng">
              <el-input v-model="ruleForm.dianpumingcheng" 
                placeholder="店铺名称" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.dianputouxiang" label="店铺头像" prop="dianputouxiang">
          <file-upload
          tip="点击上传店铺头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.dianputouxiang?ruleForm.dianputouxiang:''"
          @change="dianputouxiangUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.dianputouxiang" label="店铺头像" prop="dianputouxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.dianputouxiang.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺邮箱" prop="dianpuyouxiang">
          <el-input v-model="ruleForm.dianpuyouxiang" 
              placeholder="店铺邮箱" clearable  :readonly="ro.dianpuyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺邮箱" prop="dianpuyouxiang">
              <el-input v-model="ruleForm.dianpuyouxiang" 
                placeholder="店铺邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="积分" prop="jifen">
              <el-input v-model="ruleForm.jifen" 
                placeholder="积分" readonly></el-input>
                                                                                                                                                      ...
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主营产品" prop="zhuyingchanpin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主营产品"
                  v-model="ruleForm.zhuyingchanpin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyingchanpin" label="主营产品" prop="zhuyingchanpin">
                    <span>{{ruleForm.zhuyingchanpin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	dianputouxiang : false,
	fuzeren : false,
	shenfenzheng : false,
	lianxidianhua : false,
	dianpuyouxiang : false,
	dizhi : false,
	zhuyingchanpin : false,
	jifen : false,
	money : false,
      },
            ruleForm: {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianpumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='dianputouxiang'){
            this.ruleForm.dianputouxiang = obj[o];
	    this.ro.dianputouxiang = true;
            continue;
          }
	            	            if(o=='fuzeren'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='dianpuyouxiang'){
            this.ruleForm.dianpuyouxiang = obj[o];
	    this.ro.dianpuyouxiang = true;
            continue;
          }
	            	            if(o=='dizhi'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                            ...
                                                            dianputouxiangUploadChange(fileUrls) {
                this.ruleForm.dianputouxiang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
