          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物流公司" prop="wuliugongsi">
          <el-input v-model="ruleForm.wuliugongsi" 
              placeholder="物流公司" clearable  :readonly="ro.wuliugongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物流公司" prop="wuliugongsi">
              <el-input v-model="ruleForm.wuliugongsi" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fahuowuliu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fahuowuliuCrossAddOrUpdateFlag = false;
                  this.parent.search();
