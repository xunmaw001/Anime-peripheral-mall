...
public class MaijiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		MaijiaEntity user = maijiaService.selectOne(new EntityWrapper<MaijiaEntity>().eq("dianpubianhao", username));
    ...
    public R register(@RequestBody MaijiaEntity maijia){
    	...
    	MaijiaEntity user = maijiaService.selectOne(new EntityWrapper<MaijiaEntity>().eq("dianpubianhao", maijia.getDianpubianhao()));
		if(user!=null) {
